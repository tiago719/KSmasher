...
public class If_EP 
{
    ...
    public If_EP(boolean PosicaoPrimeiraChaveta, int EspacosIfParentesAberto, int EspacosParentesesAbertoCondicao, int EspacosCondicaoParentesFechado, int LinhasEmBrancoDepoisChavetaAberta, int LinhasEmBrancoDepoisChavetaFechada) {
