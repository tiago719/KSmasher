...
public class Medias
{
    ...
    public void fazMedias(ArrayList<Statement> Codigo)
    {
        ...
        for(int i=0;i<Codigo.size();i++)
        {
            ...
            if(Codigo.get(i) instanceof Cast)
            {
                CastsEspacosEntreCastVariavel.add(((Cast)Codigo.get(i)).getEspacosEntreCastVariavel());
            }
        }
        ...
        //cast
        for(int i=0;i<CastsEspacosEntreCastVariavel.size();i++)
        {
            total+=CastsEspacosEntreCastVariavel.get(i);
        }
        CastEspacosEntreCastVariavel=total/CastsEspacosEntreCastVariavel.size();
    }
